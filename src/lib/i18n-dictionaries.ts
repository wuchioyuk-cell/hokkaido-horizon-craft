...
const zhCN: Dict = {
  ...
  "property.oriental.rooms": "31 间客房 · 地铁站步行 3 分钟",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "札幌 · 薄野",
  "property.shinka.rooms": "精品民宿 · 8.6 分口碑 · 无接触入住",
...
const zhHK: Dict = {
  ...
  "property.oriental.rooms": "31 間客房 · 地鐵站步行 3 分鐘",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "札幌 · 薄野",
  "property.shinka.rooms": "精品民宿 · 8.6 分口碑 · 無接觸入住",
...
const en: Dict = {
  ...
  "property.oriental.rooms": "31 Rooms · 3-min Walk to Metro",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "Sapporo · Susukino",
  "property.shinka.rooms": "Boutique Inn · Rated 8.6 · Self Check-in",

...
const zhCN: Dict = {
  ...
  "property.oriental.location": "札幌 · 市区",
  "property.oriental.rooms": "31 间客房 · 地铁直达",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "札幌 · すすきの",
  "property.shinka.rooms": "精品民宿 · 薄野繁华街区",
...
const zhHK: Dict = {
  ...
  "property.oriental.location": "札幌 · 市區",
  "property.oriental.rooms": "31 間客房 · 地鐵直達",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "札幌 · すすきの",
  "property.shinka.rooms": "精品民宿 · 薄野繁華街區",
...
const en: Dict = {
  ...
  "property.oriental.location": "Sapporo · City Center",
  "property.oriental.rooms": "31 Rooms · Metro Access",
  "property.shinka.name": "Shinka Hotel Susukino",
  "property.shinka.location": "Sapporo · Susukino",
  "property.shinka.rooms": "Boutique Inn · Susukino District",
